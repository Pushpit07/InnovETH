...
export default function HubCard({item}){
    ...
    return(
        <div className="flex flex-col w-full py-16 px-20 rounded-[4.5rem] bg-[#E8E8FF]">
            ...
            <p className="text-xl font-medium font-primary">{item.description}</p>
            ...
            <div className="flex items-center justify-between w-full">
                ...
                <div className="flex flex-col items-center space-y-3">
                    <button className="rounded-full w-[60px] h-[60px] flex items-center justify-center bg-white text-black"><span class="material-symbols-outlined">bookmark</span></button>
                    <p>Bookmark</p>
                </div>
            </div>
        </div>
