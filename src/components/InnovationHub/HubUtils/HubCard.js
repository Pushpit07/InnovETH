	...
	return (
		<div className={"flex flex-col py-16 px-20 rounded-[4.5rem] bg-[#E8E8FF] " + (isFirst ? "w-full" : "w-[50%]")}>
			<div className="flex justify-between w-full">
				...
				<Link href={`/brainstorming-corner/${item.proposalId}`} passHref>
					<a className="rounded-xl w-[65px] flex items-center justify-center h-[65px] text-white text-4xl bg-[#8181FF]">
						<span className="text-4xl material-symbols-outlined">arrow_right_alt</span>
					</a>
				</Link>
			</div>
			...
			<div className="flex items-center justify-between w-full">
				...
				<div className="flex flex-col items-center space-y-3">
					<button className="rounded-full w-[60px] h-[60px] flex items-center justify-center bg-white text-black">
